...
\vspace{0.3cm}
{\color{Red}{\textbf{Step 4 }}} We get the mac address, the last 17 characters in the view.\\
\vspace{0.3cm}
{\color{Red}{\textbf{Step 5 }}} We define an intent to start a new activity.\\
\vspace{0.3cm}
{\color{Red}{\textbf{Step 6 }}} Start the activity.
\end{frame}
...
\begin{center}
\includemovie[autoplay,repeat,loop]{5cm}{5cm}{yeni_robot.mp4}
\end{center}
\end{frame}
